...
class Guard {
    ...
    accessRequest(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return redirectedUrl ? server_1.NextResponse.redirect(new URL(redirectedUrl, request.url)) : server_1.NextResponse.next();
        });
    }
    _accessUrl(request) {
        const url = request.nextUrl.clone();
    ...
    _checkPathEqual(pathFromUrl, pathFromConfig) {
        ...
        return (pathFromUrlItems.length === pathFromConfigItems.length &&
